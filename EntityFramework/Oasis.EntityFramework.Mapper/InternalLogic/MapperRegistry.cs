...
internal sealed class MapperRegistry : IRecursiveRegister
{
    ...
    private static Dictionary<Type, Delegate> MakeFactoryMethods(Dictionary<Type, Delegate> direct, IReadOnlyDictionary<Type, MethodMetaData> generated, Type type)
    {
