namespace Oasis.EntityFrameworkCore.Mapper.Test.DefaultConverter;
...
public sealed class DefaultConverterTests : TestBase
{
    ...
    public void TestStruct()
    {
        ...
        Assert.Equal(1, target.Prop!.Value.X);
        Assert.Equal(2, target.Prop.Value.Y);
    }
    ...
    private static void Test<TSource, TTarget>(TSource sourceValue, TTarget targetValue)
    {
        ...
        Assert.Equal(targetValue, target.Prop);
    }
}
